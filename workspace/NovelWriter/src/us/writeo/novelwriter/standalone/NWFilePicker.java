...
public class NWFilePicker implements FilePicker
{
	...
	public void pickFileForNew()
	{
		...
		Uri startDir = Uri.fromFile(activity.getExternalFilesDir("novelz"));
	...
	public void pickDirectory()
	{
		...
		//Uri startDir = Uri.fromFile(new File("/sdcard"));
		Uri startDir = Uri.fromFile(activity.getExternalFilesDir("templates/novels"));
		intent2Browse.setData(startDir);
		...
		activity.startActivityForResult(intent2Browse, PICK_DIRECTORY_REQUEST_CODE );
	}
